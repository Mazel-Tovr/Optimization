...
public class FibonachiSearchTask5 extends FibonachiSearch
{
    public FibonachiSearchTask5()
    {
        super(0.01, 5, 7, 10);
    }

    //TODO Тут надо что то поменять //Сколько раз необходимо вычислить функцию?
    @Override
    public void search()
    {
        double X1 = A;
